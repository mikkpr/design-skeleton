...
$("#lang-menu-toggle").click(function(e){e.stopPropagation(),$(this).toggleClass("open"),$("#toggleable-lang-menu").toggleClass("expanded")}),$("body").on("click",function(e){var l=$(e.target);0!==l.closest(".toggleable-lang-menu").length||l.is("#toggleable-lang-menu")||$("#toggleable-lang-menu").removeClass("expanded"),$("#lang-menu-toggle").removeClass("open")}),$("html").click(function(e){var l=$(e.target);0===l.closest(".mobile-menu").length&&0===l.closest(".toggle-btn").length&&$(".mobile-menu").hasClass("expanded")&&($(".mobile-menu").removeClass("expanded"),$(".js-menu-toggle").removeClass("open"))});
